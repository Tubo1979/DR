...
ap.add_argument("-i", "--image", type=str, help="path to input image that we'll apply GrabCut to")
ap.add_argument("-mask", "--mask", type=str, help="path to input mask")
...
##mask_resize = cv2.resize(args["mask2"])
